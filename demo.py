...
class FilterTagTreeFilter_script_style(bleach_extras.TagTreeFilter):
    tags_strip_content = ['script', 'style', ]
...
class FilterTagTreeFilter_SCRIPT_iframe(bleach_extras.TagTreeFilter):
    tags_strip_content = ['SCRIPT', 'iframe', ]

class IFrameFilter(bleach_extras.TagTreeFilter):
    tags_strip_content = ('script', 'style', 'iframe')


print bleach_extras.clean_strip_content(dangerous, tags=['div', ], filters=[FilterTagTreeFilter_script_style, ], strip=True)
print bleach_extras.clean_strip_content(dangerous, tags=['div', ], filters=[FilterTagTreeFilter_SCRIPT, ], strip=True)
print bleach_extras.clean_strip_content(dangerous, tags=['div', ], filters=[FilterTagTreeFilter_SCRIPT, ], strip=False)
print bleach_extras.clean_strip_content(dangerous, tags=['div', ], filters=[FilterTagTreeFilter_SCRIPT_iframe, ], strip=False)
print bleach_extras.clean_strip_content(dangerous, tags=['div', ], filters=[IFrameFilter, ], strip=False)
print bleach_extras.clean_strip_content(dangerous, tags=['div', ], filters=[IFrameFilter, ], strip=True)
...
print bleach_extras.clean_strip_content(dangerous2, tags=['div', ], filters=[IFrameFilter2, ], strip=True)
